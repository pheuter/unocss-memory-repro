				...
				const rules = [
					{
						...
						styles: {
							...
							'padding-top': '0.5rem', // spacing[2]: https://github.com/tailwindlabs/tailwindcss/blob/master/stubs/defaultConfig.stub.js#L78
							'padding-right': '0.75rem', // spacing[3]: https://github.com/tailwindlabs/tailwindcss/blob/master/stubs/defaultConfig.stub.js#L80
